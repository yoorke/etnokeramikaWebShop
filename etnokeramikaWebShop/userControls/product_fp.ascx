...
<div class="product-fp">
    <div class="wrapper">
        ...
        <div class="buttons">
            ...
            <button type="button" id="btnCompare" class="btn-compare" onclick="btnCompare_Click('<%=lblProductID.ClientID %>')"><span class="fa fa-fw fa-square-o"></span></button>
            <button type="button" id="btnWishList" class="btn-wishlist"><span class="fa fa-fw fa-heart-o"></span></button>
