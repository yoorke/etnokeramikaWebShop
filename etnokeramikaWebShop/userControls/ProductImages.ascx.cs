...
namespace etnokeramikaWebShop.userControls
{
    public partial class ProductImages : System.Web.UI.UserControl
    {
        ...
        public void ShowImages()
        {
            if (_images != null)
            {
                imgMain.ImageUrl = getDirectory(getFilename(_images[0].ImageUrl)) + getFilename(_images[0].ImageUrl) + "-" + ConfigurationManager.AppSettings["mainName"] + getExtension(_images[0].ImageUrl);
