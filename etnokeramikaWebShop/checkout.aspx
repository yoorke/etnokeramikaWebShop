<%@ Page Language="C#" MasterPageFile="~/eshop.Master" AutoEventWireup="true" CodeBehind="checkout.aspx.cs" Inherits="etnokeramikaWebShop.checkout" Title="Podaci o narudžbini | Webshop" %>
<%--@ Register src="user_controls/checkout.ascx" TagName="Checkout" TagPrefix="uc1"--%>
<%@ Register Src="userControls/CheckoutV2.ascx" TagName="CheckoutV2" TagPrefix="uc2" %>
<%@ Register Src="userControls/CheckoutInfo.ascx" TagName="CheckoutInfo" TagPrefix="uc3" %>
